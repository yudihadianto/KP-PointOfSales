    ...
    <div class="modal-content">
        ...
        <div class="modal-body modal-spa">
            ...
            <div class="col-md-7 span-1 ">
                ...
                <div class="add-to">
                    <a href="<?php echo base_url() . 'index.php/penjualan/tambah_barang/' . $detail->id_barang . '/1' ?>" type="button" class="btn btn-danger my-cart-btn my-cart-btn1">Tambahkan Ke Keranjangt</a>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
