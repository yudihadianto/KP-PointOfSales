...
<head>
	...
	<title>KP - Point Of Sales | Dashboard</title>
	...
	<div class="wrapper">
		<header class="main-header">
			...
			<a href="index2.html" class="logo">
				...
				<span class="logo-lg"><b>KP - Point Of Sales</b></span>
			</a>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2024 <a href="#">KP-Yudi 2024</a>.</strong> All rights
			reserved.
		</footer>
		<!-- /.control-sidebar -->
