	...
	<?php if ($this->session->userdata('akses') == 1) : ?>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="box box-default">
					<div class="box-header with-border">
						<h3 class="box-title">Barang Terjual Terbanyak Bulan Ini</h3>
						<div class="box-tools pull-right">
							<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
						</div>
					</div>
				...
				<div class="box box-widget widget-user">
					<div class="widget-user-header bg-green-active">
						<p style="text-align: center;">
							<span style="font-family: georgia, palatino; font-size: 15pt;">Selamat datang di Butterfly Hijab</span>
						</p>
					...
					<div class="box-footer">
						<div class="row">
							...
							<div class="col-sm-4 border-right">
								<div class="description-block">
									<h5 class="description-header">Permata Karisma Residence, Muara Sanding, Kec. Garut Kota, Kabupaten Garut, Jawa Barat 44119</h5>
									<span class="description-text">No WA : 081286291383</span>
								</div>
								<center>
